...
import { ArrowRight, MapPin, Train, GraduationCap, Search } from "lucide-react";
...
const AREA_DATA: Record<string, {
  ...
  "SW1": { name: "Westminster", region: "Central London", description: "The heart of political London, home to Buckingham Palace, St James's Park and some of the UK's most prestigious residential streets. SW1 encompasses Belgravia, Pimlico, and Victoria — a prime residential market with international demand and constrained supply.", tier: "Prime", highlights: ["Royal Parks access", "Zone 1 transport", "World-class dining", "Elite schools nearby"], nearbyAreas: ["SW3","SW7","W1","EC1"] },
  "SW3": { name: "Chelsea", region: "West London", description: "Chelsea is one of London's most enduring luxury postcodes. The Kings Road, Sloane Square, and the Chelsea Embankment define a neighbourhood that balances old money with creative energy. Strong rental demand from the international community.", tier: "Prime", highlights: ["Kings Road shopping", "Thames riverside", "Outstanding schools", "Excellent transport"], nearbyAreas: ["SW1","SW7","SW10","W8"] },
  "SW7": { name: "South Kensington", region: "West London", description: "South Kensington's 'museum quarter' draws educated, cultured buyers from around the world. The V&A, Natural History Museum, and Science Museum sit alongside white-stucco mansion buildings and well-regarded schools. A perennially resilient market.", tier: "Prime", highlights: ["World-class museums", "French Lycée nearby", "Hyde Park access", "Superb connectivity"], nearbyAreas: ["SW3","SW5","W8","SW1"] },
  "E1": { name: "Whitechapel & Spitalfields", region: "East London", description: "E1 has undergone a profound transformation over the past decade. Spitalfields' Georgian architecture, the creative scene around Brick Lane, and proximity to the City make this a favourite for young professionals and buyers looking for character with good City access.", tier: "Premium", highlights: ["City proximity", "Brick Lane culture", "Elizabeth line access", "Strong rental demand"], nearbyAreas: ["E2","EC2","N1","SE1"] },
  "E8": { name: "Hackney", region: "East London", description: "Hackney has established itself as one of London's most sought-after mid-market postcodes. Broadway Market, Victoria Park, and a thriving independent food scene attract a creative professional demographic. Strong 5-year price growth with further upside.", tier: "Premium", highlights: ["Victoria Park", "Broadway Market", "Creative community", "Overground links"], nearbyAreas: ["E2","E5","N16","E9"] },
  "N1": { name: "Islington", region: "North London", description: "Islington combines Georgian terraces, the boutiques of Upper Street, and the creative buzz of Angel. A perennially popular postcode with strong owner-occupier demand, good schools, and excellent transport into the City and West End.", tier: "Premium", highlights: ["Angel & Upper Street", "Georgian architecture", "Great schools", "Northern line & Overground"], nearbyAreas: ["N7","EC1","E1","N5"] },
  "SE1": { name: "Southwark & London Bridge", region: "South London", description: "SE1 has been transformed by the regeneration around London Bridge and Borough Market. The Shard, Tate Modern, and direct City access have made this one of South London's most sought-after postcodes — strong demand and a lively cultural offer.", tier: "Premium", highlights: ["Borough Market", "London Bridge station", "Thames views", "City of London access"], nearbyAreas: ["SE11","SE17","SW8","EC4"] },
  "W1": { name: "Mayfair & Marylebone", region: "Central London", description: "W1 is London's preeminent address — Mayfair, Marylebone, and Fitzrovia. From Georgian mansion blocks to Marylebone High Street's village atmosphere, this is a market driven by HNW individuals, family offices, and discreet international buyers.", tier: "Prime", highlights: ["Mayfair prestige", "Marylebone village", "Bond Street shopping", "Hyde Park access"], nearbyAreas: ["SW1","W2","NW1","WC1"] },
  "W8": { name: "Kensington", region: "West London", description: "Kensington Palace, Holland Park, and Kensington High Street anchor one of London's most stable prime markets. The area draws established families and international buyers who value the green space, excellent schools, and Zone 1/2 transport.", tier: "Prime", highlights: ["Kensington Palace", "Holland Park", "Outstanding schools", "Zone 1/2 tube"], nearbyAreas: ["W11","SW7","SW3","W14"] },
  "W11": { name: "Notting Hill", region: "West London", description: "Notting Hill's Portobello Road, communal garden squares, and well-documented cultural cachet make it one of London's most recognisable addresses. A tight market with limited stock, strong international demand, and consistent long-term appreciation.", tier: "Prime", highlights: ["Portobello Market", "Garden squares", "Holland Park school", "International community"], nearbyAreas: ["W10","W8","W2","W12"] },
  "M1": { name: "Manchester City Centre", region: "Greater Manchester", description: "Manchester's city centre has seen strong price appreciation over the past decade, driven by tech sector growth, major regeneration, and a large graduate population. One of the UK's most active regional markets, with broad buyer appeal and improving national connectivity.", tier: "Mid-market", highlights: ["Tech sector hub", "Active rental market", "HS2 connectivity", "University demand"], nearbyAreas: ["M2","M4","M15","M16"] },
  "M2": { name: "Manchester Spinningfields", region: "Greater Manchester", description: "Manchester's financial district, anchored by the Spinningfields development. Professional-grade apartments, proximity to the BBC and ITV media city, and strong graduate retention make this a well-connected area with broad buyer appeal.", tier: "Mid-market", highlights: ["Financial district", "BBC Media City nearby", "High rental demand", "Metrolink access"], nearbyAreas: ["M1","M3","M50","M15"] },
  "B1": { name: "Birmingham City Centre", region: "West Midlands", description: "Birmingham's Big City Plan and Commonwealth Games legacy investment has reshaped the city centre. B1 encompasses the Jewellery Quarter and business district — a regeneration story that is still playing out, with significant upside for early buyers.", tier: "Emerging", highlights: ["HSBC UK HQ", "HS2 terminus", "Jewellery Quarter", "Active property market"], nearbyAreas: ["B3","B4","B5","B16"] },
  "LS1": { name: "Leeds City Centre", region: "Yorkshire", description: "Leeds is one of the UK's strongest regional property markets. The financial quarter, thriving hospitality scene, and two major universities generate consistent rental demand. Strong value relative to London, with improving connectivity.", tier: "Mid-market", highlights: ["Financial services hub", "Two universities", "Victoria Gate retail", "Active market"], nearbyAreas: ["LS2","LS6","LS7","LS11"] },
  "BS1": { name: "Bristol City Centre", region: "South West", description: "Bristol consistently ranks among the UK's most liveable cities. The Harbourside regeneration, tech cluster around Temple Quarter, and strong graduate retention have made BS1 one of the Southwest's most popular postcodes for buyers and movers alike.", tier: "Premium", highlights: ["Harbourside living", "Tech quarter", "Clifton proximity", "Strong rental market"], nearbyAreas: ["BS2","BS3","BS6","BS8"] },
  "EH1": { name: "Edinburgh Old Town", region: "Scotland", description: "Edinburgh's Old Town and New Town are consistently ranked among the UK's most desirable residential areas. The festival economy, financial services sector, and cultural offer create year-round demand. Note: Scottish conveyancing law differs from England.", tier: "Premium", highlights: ["UNESCO World Heritage", "Festival economy", "Financial services", "University town"], nearbyAreas: ["EH2","EH3","EH4","EH9"] },
  "OX1": { name: "Oxford City Centre", region: "South East", description: "Oxford's university heritage, biotech cluster, and green-belt constraints create a structurally undersupplied market with exceptional long-term fundamentals. A firm favourite with academics, professionals, and buyers drawn to a city that consistently holds its value.", tier: "Premium", highlights: ["University town", "Biotech cluster", "Green belt constraint", "Strong demand"], nearbyAreas: ["OX2","OX3","OX4","OX44"] },
  "CB1": { name: "Cambridge", region: "East of England", description: "Cambridge's 'Silicon Fen' tech ecosystem, world-class university, and extremely constrained housing supply have created one of the UK's most resilient property markets outside London. Prices are supported by globally mobile, high-income buyers.", tier: "Premium", highlights: ["Silicon Fen tech hub", "University prestige", "Green belt constraint", "High income buyers"], nearbyAreas: ["CB2","CB3","CB4","CB5"] },
  "GL1": { name: "Gloucester", region: "South West", description: "Gloucester offers excellent value relative to neighbouring Cheltenham and Bristol. Historic cathedral city with strong commuter demand and significant regeneration activity around the docks. An emerging market with upside potential.", tier: "Mid-market", highlights: ["Cathedral city", "Gloucester Docks regen", "Commuter value", "M5 access"], nearbyAreas: ["GL2","GL3","GL4","GL50"] },
  "RG1": { name: "Reading", region: "South East", description: "Reading's proximity to London via the Elizabeth line, strong tech employer base (Oracle, Microsoft, PwC), and relatively affordable prices compared to the capital make it one of the South East's most practical choices for buyers who want London connectivity without London prices.", tier: "Premium", highlights: ["Elizabeth line to London", "Major tech employers", "University town", "Strong rental demand"], nearbyAreas: ["RG2","RG4","RG6","RG30"] },
};
