  ...
  const pricingTiers = [
    {
      ...
      price: "Free",
      period: "",
      description: "For casual browsers and first-time visitors — try the product properly with no commitment.",
    ...
    },
    {
      ...
      price: "£4.99",
      period: "/month",
      description: "The plan most serious buyers and advisers choose. Everything in Explorer plus the full pre-offer toolkit.",
      features: [
        "Unlimited briefs",
        ...
        "Broadband, air quality & infrastructure",
