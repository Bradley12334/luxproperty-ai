...
export async function generate(rawPostcode, opts = {}) {
  ...
  const sections = [pricesSection, nearbySoldPrices, streetPriceRanking, soldPricesMap, floodClimate, stationsCommute, commuteCalculator, schools, amenities, broadband, airQuality, buyingCosts, rentalSnapshot, crimeBreakdown, ...COMING_SOON_SECTIONS];
