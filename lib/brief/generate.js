...
const COMING_SOON_SECTIONS = [
  ...
  { key: "amenities",          title: "Schools & local amenities",     minTier: "EXP" },
  { key: "councilTax",         title: "Council tax band",              minTier: "EXP" },
  { key: "commuteCalculator",  title: "Full commute calculator",       minTier: "PRO" },
...
export async function generate(rawPostcode, opts = {}) {
  ...
  const sections = [pricesSection, nearbySoldPrices, streetPriceRanking, soldPricesMap, floodClimate, stationsCommute, ...COMING_SOON_SECTIONS];
