...
import { fetchStations, fetchSchools } from "./overpass.js";
...
const COMING_SOON_SECTIONS = [
  ...
  { key: "amenities",          title: "Local amenities",               minTier: "EXP" },
...
export async function generate(rawPostcode, opts = {}) {
  ...
  const sections = [pricesSection, nearbySoldPrices, streetPriceRanking, soldPricesMap, floodClimate, stationsCommute, commuteCalculator, schools, ...COMING_SOON_SECTIONS];
