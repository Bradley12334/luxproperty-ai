...
export async function generate(rawPostcode, opts = {}) {
  ...
  const sections = [executiveSummary, pricesSection, nearbySoldPrices, streetPriceRanking, soldPricesMap, floodClimate, stationsCommute, commuteCalculator, schools, amenities, broadband, airQuality, buyingCosts, rentalSnapshot, crimeBreakdown, neighbourhood, preOfferQuestions, ...COMING_SOON_SECTIONS];
