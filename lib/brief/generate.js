...
export async function generate(rawPostcode, opts = {}) {
  ...
  const sections = [pricesSection, nearbySoldPrices, streetPriceRanking, soldPricesMap, floodClimate, stationsCommute, commuteCalculator, schools, amenities, ...COMING_SOON_SECTIONS];
