...
export const ErrorCodes = Object.freeze({
  ...
  BAD_INPUT: "BAD_INPUT",
  /** The offline PPD aggregate is too old to serve, or carries no usable publication
   *  date at all. Distinct from UPSTREAM_ERROR: nothing failed at request time — the
   *  data on hand is simply not fresh enough to stand behind, which is an ops
   *  condition with a different remedy and a different message to the reader. */
