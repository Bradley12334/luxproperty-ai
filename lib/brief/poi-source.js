 ...
 * empty lists, exactly as the old Overpass bundle distinguished null from []. There is
 * NO fallback to public Overpass: the HTTP client has been removed outright (it was dead
 * on every request path and reached a third-party mirror). overpass.js now holds only the
 * pure geo/parse helpers this module feeds.
 * ─────────────────────────────────────────────────────────────────────────────
 */
