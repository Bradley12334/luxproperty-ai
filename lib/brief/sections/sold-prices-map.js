 ...
 *
 * Plots the SAME recent in-district sales the Nearby Sold Prices section lists
 ...
 */
export function buildSoldPricesMapSection(txSet, location, tier, centroids = new Map()) {
  const base = {
    key: "soldPricesMap",
  ...
  // txSet postcodes are already "DISTRICT INCODE", so they match directly.
  let geocoded = 0;
