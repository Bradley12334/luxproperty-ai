 ...
 * lib/brief/quota.js
 * ─────────────────────────────────────────────────────────────────────────────
 * SERVER-SIDE BRIEF QUOTA — the Explorer "3 briefs / calendar month" limit.
 *
 ...
 *   - EXP limit is 3/month; PRO/INV are Infinity (briefsPerMonth() in entitlements).
 *
...
export function quotaStatus(tier, used, month, now, authenticated) {
  const limit = briefsPerMonth(tier); // 3 | Infinity
